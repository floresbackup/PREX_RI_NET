...
Public Class frmMain
   ...
   Public Sub Ejecutar()
      ...
      For Each oItem In lvSel.Items
         ...
         If oItem.Checked Then
            ...
            sSQL = ReemplazarVariables(oSubProcesos(oItem.Tag).Query.ToString.Replace(Chr(0), ""))
            sSQL = ProcesosEmbebidos(ReemplazarVariables(Replace(oProcesos.Query, Chr(0), "")) & sSQL)
   ...
   Private Function ReemplazarProc(ByVal sSQL As String, ByVal sNombre As String, _
