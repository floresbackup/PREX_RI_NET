Module modConsultasSistema
   ...
   Public Sub AbrirConsulta(ByVal nCodCon As Long)
      ...
      For Each dr As DataRow In dt.Rows
         ...
         oConsulta.CodCon = dr("CS_CODCON").ToString
         oConsulta.Transaccion = dr("CS_CODTRA").ToString
         oConsulta.Nombre = dr("CS_NOMBRE").ToString
         oConsulta.Descripcion = dr("CS_DESCRI").ToString
         oConsulta.Query = System.Text.ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(dr("CS_QUERY").ToString))
         oConsulta.FechaProceso = dr("CS_FECPRO").ToString
         oConsulta.LayOut = dr("CS_LAYOUT").ToString
         oConsulta.Reporte = dr("CS_REPORT").ToString
         oConsulta.Entidad = dr("CS_CODENT").ToString
         oConsulta.Actualiza = dr("CS_UPDATE").ToString
         oConsulta.DrillDown = dr("CS_DRILLD").ToString
         oConsulta.GroupBy = dr("CS_GROUPB").ToString
         ...
         oConsulta.Alta = dr("CS_ALTA").ToString
         oConsulta.Baja = dr("CS_BAJA").ToString
         ...
         oConsulta.NuevoDesde = dr("CS_HABNDE").ToString
      ...
      For Each dr As DataRow In dt.Rows
         ...
         If dr("PS_NOMBRE").ToString.ToLower = "consformatocondicional" Or _
            dr("PS_NOMBRE").ToString.ToLower = "consactualizar" Then
            bFmtEmb = True
         End If
