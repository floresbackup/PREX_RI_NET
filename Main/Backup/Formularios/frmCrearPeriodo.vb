   ...
   Public Function ConsCrearPeriodo(ByVal sParametros As String) As Boolean
      ...
      Try
         ...
         If nCuadro = 400 Or _
            ...
            frmTablaGeneral.PasarInfo("SELECT CAST(0 AS BIT) AS [Sel.], TG_CODCON AS [Cód.], TG_DESCRI AS [Moneda] FROM TABGEN WHERE TG_CODTAB = 100 AND TG_CODCON <> 999999 ORDER BY TG_CODCON", CONN_LOCAL, 2, True, "Indique las Monedas/Especies")
