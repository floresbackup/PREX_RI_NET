...
Module modGlobalBase64


   Public Function VB6Base64Decode(ByVal BASE64TEXT_IN As String) As String
   ...
   Public Function VB6Base64Encode(ByVal TEXT_IN As String) As String
      ...
      VB6Base64Encode = sOut    'return the encoded base64 string

   End Function

   Private Function nBase64Digit(ByVal VALUE_IN As Integer) As Byte
   ...
   Private Function nBase64Value(ByVal ONEBYTE_IN As String) As Integer
   ...
   Private Function sDecode4(ByVal BASE64TEXT_IN As String) As String
   ...
   Private Function sEncode3(ByVal THREEBYTES_IN As String) As String
   ...
   Public Function IsBase64(ByVal TEXT_IN As String, Optional ByVal MSGBOX_IN As Boolean = False) As Boolean
   ...
   Private Function sRemoveWhitespace(ByVal TEXT_IN As String) As String
