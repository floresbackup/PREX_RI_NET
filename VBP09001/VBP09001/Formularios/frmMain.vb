    ...
    Private Sub GenerarTXTMultiple(ByVal nCod As Long, ByVal dFecha As Date, nReg As Integer, nPosic As Integer)
        ...
        Try
            ...
            Try
                ...
                oText = New StreamWriter(File.Open(sFile, FileMode.OpenOrCreate))
    ...
    Private Function AdjuntarArchivo(ByVal sArchivo As String, sClave As String, sDescri As String) As Boolean
        ...
        Try
            ...
            Try
                ...
                sSQL = "SELECT  * " &
                    "FROM    TXTADJ " &
                    "WHERE   AD_CODADJ = " & nProx
                Dim ds As DataSet = oAdmLocal.AbrirDataset(sSQL, da)
                ...
                dr("AD_TIPREG") = 1
                dr("AD_NROREG") = 0
                dr("AD_DESCRI") = sDescri
                dr("AD_CLAVE") = sClave
                dr("AD_NOMBRE") = modArchivos.NombreArchivo(sArchivo)
                dr("AD_ARCHIV") = File.ReadAllBytes(sArchivo)
