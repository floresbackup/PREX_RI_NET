	...
	Private Function PreparaTXT_Dinamico(ByVal nCodigo As Long,
		...
		Try
			...
			If ds.Tables(0).Rows.Count > 0 Then
				sSQL = System.Text.Encoding.GetEncoding(1252).GetString(Convert.FromBase64String(ds.Tables(0).Rows(0).Item("TN_PROCES"))) 'sBase64Decode(ds.Tables(0).Rows(0).Item("TN_PROCES"))
			End If
