...
Public Class AdmTablas
    ...
    Public Function AbrirSchema(ByVal sSQL As String, _
                                Optional ByRef sErrorText As String = "") As System.Data.DataTable

        Dim oConn As OleDb.OleDbConnection
        Dim da As OleDb.OleDbDataAdapter
        Dim dt As System.Data.DataTable
        Dim tr As System.Data.DataTable
        ...
        Try
            ...
            dt = New DataTable
            tr = da.FillSchema(dt, SchemaType.Source)
    ...
    Public Function AbrirSchemaNativo(ByVal sSQL As String, _
                                   Optional ByRef sErrorText As String = "") As System.Data.DataTable
        ...
        Try
            ...
            dt = New DataTable
            tr = oAdapter.FillSchema(dt, SchemaType.Source)
    ...
    Public Function AbrirSchemaODBCNativo(ByVal sSQL As String, _
                                       Optional ByRef sErrorText As String = "") As System.Data.DataTable
    ...
    Public Function AbrirSchemaOracleNativo(ByVal sSQL As String, _
                                            Optional ByRef sErrorText As String = "") As System.Data.DataTable
