...
Public Class frmParametro
    ...
    Private bHabilitaCustomSearch As Boolean
    Private sMensajeCustomSearch As String
    Private sVariableCustomSearch As String
        ...
        For Each oRow In dsAux.Tables("PARAMS").Rows
            If oRow.RowState <> DataRowState.Deleted Then
                If oRow.Item("CD_ORDEN") = ORDEN Then
                    ...
                    bHabilitaCustomSearch = oRow.Item("CD_USABUS") = 1
                    sMensajeCustomSearch = oRow.Item("CD_MSJBUS")
                    sVariableCustomSearch = oRow.Item("CD_VARBUS")
    ...
    Private Sub LocalizarFormulario()
        ...
        cmdCustom.Text = DescripcionCadena(Cadenas.CDN_frmDisenoConsulta_BotonCustomSearch)
        cmdAsistenteSQL.Text = DescripcionCadena(Cadenas.CDN_frmDisenoConsulta_BotonAsistenteSQL)

        cmdEditarExpresion.ToolTip = DescripcionCadena(Cadenas.CDN_WindowCaptionConstruirExpresion)
    ...
    Private Sub Actualizar()
        ...
        Try
            ...
            With dsAux.Tables("PARAMS")
                ...
                oRow.Item("CD_USABUS") = IIf(bHabilitaCustomSearch, 1, 0)
                oRow.Item("CD_MSJBUS") = sMensajeCustomSearch
                oRow.Item("CD_VARBUS") = sVariableCustomSearch
    ...
    Public Sub New(ByVal sConexionActual As String, ByVal nTipoConexion As Integer, ByVal sSQLConsulta As String)
        ...
        SQL_CONSULTA = sSQLConsulta

        DISENO_CUSTOM_SEARCH_HABILITADA = False
        DISENO_CUSTOM_SEARCH_MENSAJE = ""
        DISENO_CUSTOM_SEARCH_VARIABLE = ""

        bHabilitaCustomSearch = False
        sMensajeCustomSearch = ""
        sVariableCustomSearch = ""
    ...
    Private Sub cmdAsistenteSQL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAsistenteSQL.Click
        ...
        fWiz.txtSQL.Text = txtSQL.Text

        Try

            fWiz.qbMain.SyncSQL = txtSQL.Text
    ...
    Private Sub cmdCustom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCustom.Click
        ...
        Dim fCustom As New frmDisenoCustomSearch(bHabilitaCustomSearch, sMensajeCustomSearch, sVariableCustomSearch)

        fCustom.ShowDialog()
        fCustom.Dispose()

        If DISENO_CUSTOM_SEARCH_ACEPTADO Then
            bHabilitaCustomSearch = DISENO_CUSTOM_SEARCH_HABILITADA
            sMensajeCustomSearch = DISENO_CUSTOM_SEARCH_MENSAJE
            sVariableCustomSearch = DISENO_CUSTOM_SEARCH_VARIABLE
        End If

    End Sub

    Private Sub cmdEditarExpresion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEditarExpresion.Click

        Dim sVariable As String
        Dim fExpr As frmEditorExpresion

        sVariable = txtVariable.Text.Trim
        fExpr = New frmEditorExpresion(SQL_CONSULTA, sVariable, CONEXION_ACTUAL, TIPO_CONEXION)

        fExpr.ShowDialog()
        fExpr.Dispose()

        If EXPRESION_DEVUELTA <> "" Then
            txtParteSQL.Text = EXPRESION_DEVUELTA
            txtParteSQL.Focus()
        End If
