...
Public Class frmPersonalizarCubo
    ...
    Private Sub LocalizarFormulario()
        ...
        cmdFormatoCondicional.Text = DescripcionCadena(Cadenas.CDN_WindowCaptionFormatoCondicional) & " ..."
    ...
    Private Sub PropiedadesItem(ByVal oItem As ListViewItem)
        ...
        fCampo = New frmColumnaCubo(oFCons)
        fCampo.Iniciar()
    ...
    Private Sub cmdFormatoCondicional_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFormatoCondicional.Click

        Dim oFormFormatos As frmFormatoCondicional

        'If oCubo.FormatConditions.Count > 0 Then
        'If Pregunta(DescripcionCadena(Cadenas.CDN_frmFormatoCondicional_WarningEliminar)) = Windows.Forms.DialogResult.No Then
        'Exit Sub
        'End If
        'End If

        oFormFormatos = New frmFormatoCondicional(oFCons)
        oFormFormatos.ShowDialog()

        oFormFormatos.Dispose()
