...
Public Class frmMainX
    ...
    Private REGISTRY_BASE_PATH As String = "EDR\Qualitas\"
    ...
    Private Sub ParseCommandLine()
        ...
        Dim nPosIgual As Integer

        For nI = 0 To My.Application.CommandLineArgs.Count - 1

            sTemp = My.Application.CommandLineArgs(nI).Replace("/", "")

            nPosIgual = InStr(sTemp, "=")

            sCommand = sTemp.Substring(0, nPosIgual - 1).ToUpper
            sValue = sTemp.Substring(nPosIgual).Trim

            Select Case sCommand
                Case "UID" : CMDLINE_CODIGO_USUARIO = sValue
                Case "PWD" : CMDLINE_PASSWD_USUARIO = sValue
                Case "APP" : CMDLINE_NOMBRE_APP = sValue
            End Select
    ...
    Public Sub SetSkin()
        ...
        If THEME_ACTUAL = "Windows XP" Then
            oLAF.LookAndFeel.SetWindowsXPStyle()
        ElseIf THEME_ACTUAL = "Windows 3D" Then
            oLAF.LookAndFeel.SetStyle3D()
        Else
            oLAF.LookAndFeel.SetSkinStyle(THEME_ACTUAL)
        End If
    ...
    Public Sub AbrirEjecucionConsulta(ByVal nCodigoConsulta As Integer)
    ...
    Public Sub AbrirDisenoConsulta(ByVal nCodigoConsulta As Integer)
    ...
    Public Sub NuevoDisenoConsulta()
        ...
        If ConnectionCount() <= 0 Then
            MensajeError(DescripcionCadena(Cadenas.CDN_GeneralNoHayConexiones))
            Exit Sub
        End If
        ...
        fCons.Show()
        mdiTabs.SelectedPage.Image = il16x16.Images(4)
    ...
    Private Function ConnectionCount() As Integer
        ...
        sSQL = "SELECT COUNT(1) AS XX_CANTID " & _
               "FROM   TABGEN " & _
               "WHERE  TG_CODTAB=4 " & _
        ...
        Try
            ...
            ds = oAdmTablas.AbrirDataset(sSQL)
            Return ds.Tables(0).Rows(0)("XX_CANTID")
            ds.Dispose()
    ...
    Public Sub PreAperturaConsulta()
    ...
    Public Sub AdministrarConexiones()
    ...
    Public Sub AdministrarCategorias()
    ...
    Public Sub PreExportarConsulta()
        Dim nCodConsulta As Integer
    ...
    Public Sub PreImportarConsulta()
        If MODO_DEMO Then
    ...
    Private Sub btnEliminarConsulta_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnEliminarConsulta.ItemClick
        PreEliminacionConsulta()
    End Sub

    Public Sub PreEliminacionConsulta()
        Dim nCodConsulta As Integer
