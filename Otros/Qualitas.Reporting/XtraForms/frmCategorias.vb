Public Class frmCategorias 
    ...
    Private Sub CargarTree()
        ...
        nodX = tvMain.Nodes("nodRaiz")
        nodX.EnsureVisible()
        tvMain.SelectedNode = nodX
        tvMain.Focus()
    ...
    Private Sub tvMain_BeforeLabelEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.NodeLabelEditEventArgs) Handles tvMain.BeforeLabelEdit
