Public Class frmLogin 
    ...
    Private Sub frmLogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '''' INICIO DESDE EL COMMAND LINE ''''
        If CMDLINE_HABILITAR_LOGIN Then
            If CMDLINE_INVOCADA Then
                If CMDLINE_CODIGO_USUARIO <> "" Then
                    txtNombreLogin.Text = CMDLINE_CODIGO_USUARIO
                    txtNombreLogin.Enabled = False
                    txtDominio.Enabled = False
                    If CMDLINE_PASSWD_USUARIO <> "" Then
                        txtPassword.Text = CMDLINE_PASSWD_USUARIO
