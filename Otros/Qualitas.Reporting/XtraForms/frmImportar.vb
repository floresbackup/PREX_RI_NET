    ...
    Private Sub Guardar()
        ...
        Try
            ...
            With ds.Tables(0)
                ...
                oRow("CV_PASSDS") = dsConsulta.Tables(0).Rows(0)("CV_PASSDS")
                oRow("CV_PASSDG") = dsConsulta.Tables(0).Rows(0)("CV_PASSDG")
            ...
            With ds.Tables(0)
                ...
                If dsConsulta.Tables.Contains("CONDET") Then

                    For Each oRowTemp In dsConsulta.Tables("CONDET").Rows
            ...
            With ds.Tables(0)
                ...
                If dsConsulta.Tables.Contains("CONFOR") Then

                    For Each oRowTemp In dsConsulta.Tables("CONFOR").Rows
                        If oRowTemp.RowState <> DataRowState.Deleted Then
                            oRow = .NewRow
            ...
            With ds.Tables(0)
                ...
                If dsConsulta.Tables.Contains("CONRES") Then

                    For Each oRowTemp In dsConsulta.Tables("CONRES").Rows
                        If oRowTemp.RowState <> DataRowState.Deleted Then
                            oRow = .NewRow
            ...
            ''''' TRATAMIENTO TABLA CONLAY '''''

            sSQL = "SELECT  * " & _
                   "FROM    CONLAY " & _
                   "WHERE   CL_CODCON = " & nCodConsulta & " "
            ...
            With ds.Tables(0)
                ...
                If dsConsulta.Tables.Contains("CONLAY") Then

                    nI = oAdmTablas.ProximoID("CONLAY", "CL_CODLAY")

                    For Each oRowTemp In dsConsulta.Tables("CONLAY").Rows
                        If oRowTemp.RowState <> DataRowState.Deleted Then
                            oRow = .NewRow
                            oRow("CL_CODLAY") = nI
                            oRow("CL_CODCON") = nCodConsulta
                            oRow("CL_CODUSU") = USUARIO_ACTUAL
                            For Each oField In .Columns
                                If oField.ColumnName <> "CL_CODCON" And _
                                   oField.ColumnName <> "CL_CODUSU" And _
                                   oField.ColumnName <> "CL_CODLAY" Then
                                    oRow(oField.ColumnName) = oRowTemp(oField.ColumnName)
                                End If
                            Next
                            .Rows.Add(oRow)
            ...
            With ds.Tables(0)
                ...
                If dsConsulta.Tables.Contains("REPORT") Then

                    For Each oRowTemp In dsConsulta.Tables("REPORT").Rows
                        If oRowTemp.RowState <> DataRowState.Deleted Then
                            oRow = .NewRow
                            oRow("RP_CODCON") = nCodConsulta
                            oRow("RP_CODUSU") = USUARIO_ACTUAL
                            For Each oField In .Columns
                                If oField.ColumnName <> "RP_CODCON" And _
                                   oField.ColumnName <> "RP_CODUSU" Then
                                    oRow(oField.ColumnName) = oRowTemp(oField.ColumnName)
                                End If
                            Next
                            .Rows.Add(oRow)
