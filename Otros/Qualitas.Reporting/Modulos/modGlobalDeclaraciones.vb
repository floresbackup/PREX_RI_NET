Public Module modGlobalDeclaraciones
    ...
    Public EDICION_SQL_HABILITADA As Integer
    Public AQB_MOSTRAR_TABLAS As Integer
    Public AQB_MOSTRAR_VISTAS As Integer
    Public AQB_MOSTRAR_SPS As Integer
    Public HELP_PATH As String
    Public OBJECT_IDENTIFIER_START As String
    Public OBJECT_IDENTIFIER_CLOSE As String
    ...
    Public LOAD_LAYOUT_SUCCESS As Boolean
    Public CANCEL_SAVE_LAYOUT As Boolean

    Public DISENO_CUSTOM_SEARCH_HABILITADA As Boolean
    Public DISENO_CUSTOM_SEARCH_MENSAJE As String
    Public DISENO_CUSTOM_SEARCH_VARIABLE As String
    Public DISENO_CUSTOM_SEARCH_ACEPTADO As Boolean
    Public RETORNO_CUSTOM_SEARCH As String

    Public EXPRESION_DEVUELTA
    ...
    Public MULTIFILTER_COLUMNS As Integer
    Public SHOW_PERCENT_PB As Boolean

    ' Posibles argumentos desde la linea de comandos
    Public CMDLINE_CODIGO_USUARIO As String
    Public CMDLINE_PASSWD_USUARIO As String
    Public CMDLINE_NOMBRE_APP As String
    Public CMDLINE_INVOCADA As Boolean
    public CMDLINE_HABILITAR_LOGIN As Boolean
    ...
    Public Structure Consulta
        ...
        Public ProtegidaDiseno As Boolean
        Public PasswordDiseno As String
    ...
    Public Structure DetalleConsulta
        ...
        ' Nuevo 2009-03-05
        Public UsaBusquedaPrevia As Boolean
        Public MensajeBusqueda As String
        Public VariableBusqueda As String
        ' Fin nuevo
